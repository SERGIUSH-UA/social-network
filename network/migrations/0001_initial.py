    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_avatar', models.ImageField(blank=True, default='no-avatar-png-transparent.png', upload_to='')),
                ('birthday', models.DateField(blank=True, verbose_name='Birthday')),
                ('work_place', models.CharField(blank=True, max_length=90, verbose_name='Work place')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date_create', models.DateTimeField(blank=True, default=django.utils.timezone.now, verbose_name='Created date')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Created date', models.DateTimeField(default=django.utils.timezone.now)),
